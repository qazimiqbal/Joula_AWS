...
<head>
    ...
    <script type="text/javascript" src="http://maps.google.com/maps/api/js?sensor=true&language=en&libraries=geometry"></script>    
        ...
        <div data-role="mycontent" id="mycontent">
            <script>
				...
				$(document).ready(function(){
					...
					$.getJSON('getaddressdata.php?locality=<?php echo $locality; ?>&area=<?php echo $area; ?>', function(data) {                 
						//**********
						...
						$.each(addressdataArray, function(key, val) {
							...
							string += "<tr><td><font color='black'><b>Address</b></font></td><td><font color='#660000'>"+val.H_No+" "+val.St_Name+" "+val.City+" "+val.State+" "+val.Zip+"</font><br><a href='http://maps.google.com/?q="+val.H_No+" "+val.St_Name+" "+val.City+" "+val.State+" "+val.Zip+"' target='_new'><font color='#660000'>Navigate me here</font></a></td></tr>";
							...
							{ 							
								...
								//string += "<tr><td><font color='black'><b>Details</b></font></td><td><font color='#660000'><a href='http://www.samawar.com/Joula/mobile/edit.php?id="+val.ID+"'  rel='external' target='_new'>Edit</a></font></td></tr>";
								}
								<?php								
							}	
							?>
