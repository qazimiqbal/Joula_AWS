   ...
   <script>
		...
		function showNearestMasjid(latt, longg){
			var glatlng_unit = new google.maps.LatLng(latt, longg);
			 $.getJSON('getmasjiddata.php', function(data) {
		...
		function calcDistance_fromYou(latt, longg){
			//alert(latt+" - "+longg);
			var glatlng1 = new google.maps.LatLng(latt, longg);
			try
			{
		...
		function getLocation(){
            if(navigator.geolocation) {
                navigator.geolocation.watchPosition(function(position) {
                    ...
                    yourLatLocation = position.coords.latitude;
                    yourLongLocation = position.coords.longitude;
                    alert(yourLatLocation);
                    if(yourLatLocation != ''){
                        return yourLatLocation;
                    }
                });
            } else {
                            ...
                            if(position.coords.latitude != ''){
                                ...
                                if(!myPos) {
                                    ...
                                    $('#map_canvas').gmap('addMarker', {
                                        ...
                                        $('#map_canvas').gmap('openInfoWindow', {'content': 'Your location is here'}, this);
                                    });


                                    //alert('https://www.myjoula.com/mobile/getaddressdata2.php?distance=<?php echo $mydistance; ?>&yourlat='+yourLatLocation+'&yourlong='+yourLongLocation);
                                    //alert('getsathidata.php?state=<?php echo $state; ?>');
									$.getJSON('getsathidata.php?state=<?php echo $state; ?>', function(data) {
                                        ...
                                        $.each(addressdataArray, function(key, val) {
                                           ...
                                           if(i < 7){
											...
											if(val.Three_D_Men >= 1){var imgpath = 'images/three_days-20.png';   var colorcode = 'Spent Three Days'}
											if(val.Forty_D_Men >= 1){var imgpath = 'images/Forty_Days-20.png';   var colorcode = 'Spent Forty Days'}
											if(val.Four_M_Men >= 1){var imgpath = 'images/four_month-20.png';   var colorcode = 'Spent Four Months'}
											

                                            if(myzoomid != 0){
                                                if(val.ID == <?php echo $zoomid; ?>){
                                                    //alert(myzoomid)
                                                    zoom_coord = coordinate_location;
                                            ...
                                            string += "<tr><td><font color='black'><b>Last Visit</b></font></td><td><font color='#660000'>"+val.Last_Visit+"  ( "+lastAction+")</font></td></tr>";
											
											
											
											string += "<tr><td><font color='black'><b>4 Month brothers</b></font></td><td><font color='#660000'>"+val.Four_M_Men+"  </font></td></tr>";
											string += "<tr><td><font color='black'><b>40 day brothers</b></font></td><td><font color='#660000'>"+val.Forty_D_Men+"  </font></td></tr>";
											string += "<tr><td><font color='black'><b>10 day brothers</b></font></td><td><font color='#660000'>"+val.Ten_D_Men+"  </font></td></tr>";
											string += "<tr><td><font color='black'><b>3 day brothers</b></font></td><td><font color='#660000'>"+val.Three_D_Men+"  </font></td></tr>";
											
											string += "<tr><td><font color='black'><b>40 day Sisters</b></font></td><td><font color='#660000'>"+val.Forty_D_Female+"  </font></td></tr>";
											string += "<tr><td><font color='black'><b>10 day Sisters</b></font></td><td><font color='#660000'>"+val.Ten_D_Female+"  </font></td></tr>";
											string += "<tr><td><font color='black'><b>3 day Sisters</b></font></td><td><font color='#660000'>"+val.Three_D_Female+"  </font></td></tr>";
                                            
											string += "<tr><td><font color='black'><b>Comments</b></font></td><td><font color='#660000'>"+val.Comments+"</font></td></tr>";
                                            <?php
                                            if (isset($_SESSION['username']))
                                            {
                                                ?>
											...
											//if(i < 30) {
												//alert(val.Coordinates);
												//alert(latt+","+longg);
											var dist_to_you = parseInt(calcDistance_fromYou(latt,longg))+1;
											//alert(dist_to_you);
											
													if(val.Coordinates != "NA") {
													$('#map_canvas').gmap('addMarker', {
														icon: new google.maps.MarkerImage(imgpath),
														'position': coordinate_location,
														'Id': 'Address',
														'bounds': true
