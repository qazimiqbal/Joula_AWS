...
<head>
	...
	<script type="text/javascript" src="https://myjoula.com/mobile/scripts/js-marker-clusterer-gh-pages/src/markerclusterer.js"></script>
   <script>
                    ...
                    $.getJSON('getaddressdata.php?<?php echo $myparams; ?>', function(data) {
						...
						$.each(addressdataArray, function(key, val) {
							...
							if(i < 3){
								//alert(res[0] +" - "+latt);
								//alert(res[1] +" - "+longg);
								//alert(val.Coordinates +" - "+coordinate_location);
							}
