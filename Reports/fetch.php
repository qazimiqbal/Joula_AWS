...
//	//$query .= " Where Ethinicity = 'Bosnian' ";
//	$query .= "
//	WHERE Ethinicity = 'African'
//	";
//}
//$query .= " and Locality = '".$locality."' ";
//$query .= " and Ethinicity = 'African' ";
...
{
	$query = "SELECT * FROM Addresses2 where Ethinicity = 'African'";
