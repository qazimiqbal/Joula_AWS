...
$mydistance = urldecode($_GET['mydistance']);
$myparams = "distance=".$mydistance;
        ...
        <div data-role="mycontent" id="mycontent">
            <script>
				...
				$(document).ready(function(){
					$("#map_canvas" ).html("<div style='text-align:center;'><br><br><br><span class='red'><img src='images/loading.gif'></span></div>");
...
//                                    //alert('https://www.myjoula.com/mobile/getdistancedata.php?distance=<?php //echo $mydistance; ?>//&yourlat='+yourLatLocation+'&yourlong='+yourLongLocation);
                                    //alert('https://www.myjoula.com/mobile/getdistancedata.php?distance=<?php echo $mydistance; ?>&yourlat='+yourLatLocation+'&yourlong='+yourLongLocation);
                                    $.getJSON('getdistancedata.php?distance=<?php echo $mydistance; ?>&yourlat='+yourLatLocation+'&yourlong='+yourLongLocation, function(data) {
									//$.getJSON('https://www.myjoula.com/mobile/getaddressdata.php?distance=10&yourlat=33.755711&yourlong=-84.3883717', function(data) {
                                        //**********
                                        // Try HTML5 geolocation
                                        //**********
                                        addressdataArray = data;
                                        //AddAddressData()
										//alert(length.addressdataArray);
							...
							//alert(longg);
											...
											var bufferdistance = parseInt("<?php echo $mydistance; ?>");
											//alert(dist_to_you);
											if(dist_to_you <= bufferdistance){
