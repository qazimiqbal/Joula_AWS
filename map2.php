...
<head>
    ...
    <!--    <script async defer src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCXCr6g7Lgn1Y3iMUu2xe-ECdrca7ZKTDs&sensor=true&language=en&libraries=geometry"type="text/javascript"></script>-->
    ...
    <!--    <script async defer src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCXCr6g7Lgn1Y3iMUu2xe-ECdrca7ZKTDs&callback=initMap"-->
        ...
        <script>
            ...
            $(document).ready(function(){
                ...
                $.getJSON('getaddressdata.php?<?php echo $myparams; ?>', function(data) {
                    ...
                    $.each(addressdataArray, function(key, val) {
                        ...
                        string += "<tr><td><font color='black'><b>Address</b></font></td><td><font color='#660000'><div id='content'>"+val.H_No+" "+val.St_Name+" "+val.City+" "+val.State+" "+val.Zip+"</font><br><a href='https://maps.google.com/?q="+val.H_No+" "+val.St_Name+" "+val.City+" "+val.State+" "+val.Zip+"' target='_new'></div><font color='#660000'>Navigate me here</font></a></td></tr>";
                        ...
                        string += "<tr><td><font color='black'><b>Last Visit</b></font></td><td><div id='content'><font color='#660000'>"+lastvisitString+"</font></div></td></tr>";
                        string += "<tr><td><font color='black'><b>Comments</b></font></td><td><div id='content'><font color='#660000'>"+val.Comments+"</font></div></td></tr>";
                        <?php
                        if (isset($_SESSION['username']))
                        {
                        ?>
            ...
            function AddMasjidData(){
                ...
                $.each(masjiddataArray, function(key, val) {
                    ...
                    string += "<td><font color='black'><b>Name</b></font></td><td><font color='#660000'>"+val.Name+"</font></td></tr>";
                    string += "<tr><td><font color='black'><b>City</b></font></td><td><font color='#660000'>"+val.City+"</font></td></tr>";
                    string += "<tr><td><font color='black'><b>Address</b></font></td><td><div id='content'><font color='#660000'>"+val.H_No+" "+val.St_Name+" "+val.City+" "+val.State+" "+val.Zip+"</font></div></td></tr>";
                    string += "<tr><td><font color='black'><b>Status</b></font></td><td><font color='#660000'>"+val.Status+"</font></td></tr>";
                    ...
                    string += "<tr><td><font color='black'><b>Comments</b></font></td><td><div id='content'><font color='#660000'>"+val.R1_comments+"</font></div></td></tr>";
