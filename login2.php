...
//		echo "ID = ".$_SESSION['id']."<BR>Username = ".$_SESSION['username']."<BR>Halqa = ".$_SESSION['halaqa']."<BR>Permission = ".$_SESSION['permissions']."<BR>";
...
//		echo $_SESSION['permissions_level']."<BR>";
		...
		//echo "https://".$_SERVER['HTTP_HOST']."/mobile/index.php";

		header("location: https://".$_SERVER['HTTP_HOST']."/mobile/index_dev.php");
		exit;
		//****************************************SEND MAIL *************************************
		/*
	...
	{
		$credentials = "<center>Username or password did not match</center>";
